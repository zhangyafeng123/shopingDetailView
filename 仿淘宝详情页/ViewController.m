...
@property (nonatomic, strong)RecognizeSimultaneouslyWithGestureRecognizerTableView *tableView;
...
-(void)initUI{
    [self initPicView];
    _tableView = [[RecognizeSimultaneouslyWithGestureRecognizerTableView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame)-kBottomBarHeight) style:UITableViewStylePlain];
...
-(void)initPicView{
    ...
    picView.image = [UIImage imageNamed:@"1.jpg"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (section==0) {
        ...
        FFTableView *tabView = [[FFTableView alloc] initWithTabConfigArray:tabConfigArray];
